<template>
  <div class="page broadband">
    <common-header title="光纤宽带客户变化明细"></common-header>
    <div class="content">
      <div class="toolbox">
        <div class="left">
          <span>数据日期：</span>
        ...
        >
          ...
          >
            <template #default="scope">
              ...
              <span v-else-if="index === 'restBalance'">{{ scope.row[index] == null || scope.row[index] == undefined ? '-' : scope.row[index]/100  }}</span>
...
export default {
  ...
  methods: {
    ...
    confirm() {
      ...
      window.localStorage.setItem('broadband', JSON.stringify(this.tableHeader))
  ...
  created() {
    ...
    let t = window.localStorage.getItem('broadband')
